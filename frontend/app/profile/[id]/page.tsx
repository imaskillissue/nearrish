...
export default function ProfileViewPage() {
  ...
  useEffect(() => {
    async function load() {
      // TODO: Connect to real backend API to fetch profile and current user
      setStatus('not_found');
    }
    load();
  }, [profileId]);
  ...
  async function handleSaveEdit() {
    ...
    // TODO: Connect to real backend API to update profile
    setProfile(p => p ? {
      ...p,
      address:   editAddress,
      interests: editInterests,
    ...
    setEditMsg('Saved (locally only — backend not connected).');
    setEditing(false);
