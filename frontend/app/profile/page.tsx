...
/**
 * Crops the image to a square base64 string using the user's drag position.
 */
...
export default function ProfilePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Upload avatar directly after registration
      if (avatarData) {
        try {
          ...
          // FIXED: Use API_BASE constant for consistency across environments
      ...
      setSaveError(err instanceof Error ? err.message : 'Registration failed.');
      setIsSaving(false);
    }
  }
      ...
      <div className={styles.card}>
        ...
        <div className={styles.bottomRow}>
          <div className={styles.bottomLeft}>
            ...
            >
              <button className={styles.saveButton} onClick={handleSave} disabled={!isValid || isSaving}>
