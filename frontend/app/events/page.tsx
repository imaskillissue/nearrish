...
export default function EventsPage() {
  ...
  const loadAll = useCallback(async () => {
    // TODO: Connect to real backend API to fetch events and attending status
    setEvents([]);
  ...
  async function handleSave(data: Record<string, unknown>) {
    // TODO: Connect to real backend API to create/edit event
    setModal(null);
    await loadAll();
  }

  async function handleSeed() {
    // TODO: Connect to real backend API to seed events
    await loadAll();
  }
